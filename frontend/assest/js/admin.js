    ...
    try {
        ...
        data.forEach((entry) => {
            const responses = {
                ...
                "Pays de résidence actuel": entry.residence_country,
                "Profession actuelle": entry.current_job,
                ...
                "8.2 Comment réussir l’implémentation d’une formation par alternance à SJD ?":
                    entry.work_study,
                "8.3 Comment développer davantage la culture d’entreprise par un esprit d’entrepreneuriat à SJD ?":
                    entry.entrepreneurship_culture,
